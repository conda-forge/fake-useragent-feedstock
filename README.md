...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/fake-useragent-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13240&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/fake-useragent-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `fake-useragent` can be installed with:

```
conda install fake-useragent
```

It is possible to list all of the versions of `fake-useragent` available on your platform with:
